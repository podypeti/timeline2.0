...
// ===== Version & config =====
console.log('[timeline] script loaded v6-patch');
const ASSET_VERSION = '6-patch';
const MIN_YEAR = -4050;
const MAX_YEAR = 2100;
...
if (btnReset) btnReset.addEventListener('click', () => { initScaleAndPan(); draw(); });
